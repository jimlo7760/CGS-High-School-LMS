<img src="http://38.106.21.18:3000/repo-avatars/14-f2d9a2e1cc4c7f6b4a056d2ffe38758b" align=center width=200>
...
- [ ] 查询成绩
  - [ ] 输入框输入条形码或姓名 or 从自己的行政班级的列表中选择学生
  - [ ] 按下查询按钮
  - [ ] 列出学生成绩信息
- [ ] 更改成绩
  - [ ] 输入学生姓名/条形码 or 从自己的行政班级的列表中选择学生
  - [ ] 输入成绩
  - [ ] 提交修改后的成绩表
- [ ] 学生电子档案相关
  - [ ] 目标大学
