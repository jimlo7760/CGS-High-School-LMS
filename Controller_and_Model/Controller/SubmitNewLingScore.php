...
if ((isset($_POST["language-test-type"]) && $_POST["language-test-type"] != NULL) &&
    (isset($_POST["language-test-overall"]) && $_POST["language-test-overall"] != NULL) &&
    ...
    $tot_res = InsertNewLingScore($_SESSION["id"], $test_type, $test_score, $overall_score, $comments, $test_date);
    if ($tot_res[1] > 0) {
        ob_start();
